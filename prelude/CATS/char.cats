...
** Time of generation: Sun Aug  2 22:18:17 2020
*/
...
static inline int isascii(int c) { return (0 <= c) && (c <= 0177); }
...
static inline int isgraph(int c) { return (041 <= c) && (c <= 0176); }
static inline int isprint(int c) { return (040 <= c) && (c <= 0176); }
static inline int ispunct(int c) { return isgraph(c) && !isalnum(c); }
static inline int toupper(int c) { return c ^ (islower(c) ? 0x20 : 0); }
static inline int tolower(int c) { return c ^ (isupper(c) ? 0x20 : 0); }
static inline int iscntrl(int c) { return (c == 0177) || ((0 <= c) && (c <= 037)); }
